...
type LocalTargetFactor struct {
	targets target.TargetContainer
}

// NewLocalTargetFactor creates a new local target factor
func NewLocalTargetFactor(targets target.TargetContainer) *LocalTargetFactor {
...
// Factorize returns the factorized target
func (l LocalTargetFactor) Factorize(ctx context.Context, targetID string) (target.Target, error) {
