...
type CreateUserProfileFactory struct{}

func (f CreateUserProfileFactory) Factory(
	ctx context.Context,
	ctr *app.Container,
	id int,
	...
	req := executor.CreateUserProfileReq{
		AuthToken:    authToken,
	...
	return executor.RequestContent[executor.CreateUserProfileReq, response.CommandResponseDto]{
		Req:          req,
